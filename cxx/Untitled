...
Prefer stealing a releasing voice
...
If no releasing voice: steal an active voice
...
Phase 1: Implement Processor base class and PerformanceProfiler



Phase 2: Implement OscillatorProcessor base class and migrate oscillators:
...
Phase 3: Implement EnvelopeProcessor base class and migrate envelope:
...
Phase 4: Implement Graph for chaining (Pull Model)



Phase 5: Implement Voice and VoiceManager (Pull Model)



Phase 6: Implement cross-platform AudioDriver HAL:
...
Phase 7: Implement C interop layer
...
Embedded profiling timer: Cycle counter is the preferred option for embedded (most lightweight, least invasive).
